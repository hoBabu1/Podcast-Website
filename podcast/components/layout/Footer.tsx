...
export function Footer() {
  return (
    <footer className="border-t border-brand-border py-6 sm:py-8 mt-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row justify-between items-center gap-4">
        <p className="text-brand-body text-sm">© 2026 DefiLords</p>
        <div className="flex items-center gap-5">
          <Link
            href="https://x.com/defilordsss?s=21"
            target="_blank"
            rel="noopener noreferrer"
            className="text-brand-body hover:text-brand-amber transition-colors duration-200"
            aria-label="Twitter"
          >
